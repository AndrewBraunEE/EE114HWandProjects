...
The average training and test losses and accuracies for both the feed-forward neural network and LSTM are given in \Cref{tab:avg_acc}.
\begin{table}[ht]
	\centering
...
\begin{table}[!ht]
	...
	\begin{tabularx}{\linewidth}{|X|X|X|X|X|}
		...
		\hline
	\end{tabularx}
	\caption{Table of best training accuracies and losses for the feed-forward neural network and the LSTM observed over a single training/testing split. Accuracies over this run are given in \Cref{fig:best_ff}.}
	\label{tab:best_acc}
\end{table}
